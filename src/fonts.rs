...
pub fn setup_fonts(mut ctx: ResMut<EguiContext>) {
    ...
    fonts.font_data.insert("toxigenesis".to_owned(),
    ...
    fonts.family_and_size.insert(
        TextStyle::Small,
        (FontFamily::Monospace, 16.0)
    );

    fonts.family_and_size.insert(
        TextStyle::Body,
        (FontFamily::Monospace, 22.0)
    );

    fonts.family_and_size.insert(
        TextStyle::Heading,
        (FontFamily::Monospace, 32.0)
    );

    fonts.family_and_size.insert(
        TextStyle::Button,
        (FontFamily::Monospace, 24.0)
    );

    fonts.family_and_size.insert(
        TextStyle::Monospace,
        (FontFamily::Monospace, 20.0)
    );
